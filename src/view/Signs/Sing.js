  ...
  return (
    <>
      <div className="features-container">
        ...
        <p>Zomato Partner Platform helps you take your business to new heights instantly with no hassle and</p>
        <p>100% transparency!</p>
        <div className="feature">
          <div className="feature-icon">1</div>
          <div className="feature-text">
            <h3>Restaurant Partner app</h3>
            <p>Manage all your orders on your </p>
            <p>smartphone with our Android app</p>
          </div>
        </div>
        <div className="feature">
          ...
          <div className="feature-text">
            ...
            <p>Manage all your orders on your desktop</p>
            <p>or laptop</p>
          </div>
        </div>
        <div className="feature">
          ...
          <div className="feature-text">
            ...
            <p>Manage all your orders on your existing </p>
            <p>Point of Sale (POS) or third-party software</p>
          </div>
        </div>
        ...
        <div className='divya'>
          ...
          <h1 className='Vibe'>Start your journey with Zomato</h1>
          <h2 className='glass'>Create your restaurant page and register for online ordering</h2>
